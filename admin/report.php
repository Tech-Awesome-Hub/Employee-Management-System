                ...
                <div class="table-responsive">
                    ...
                    <?php
                     if(isset($_REQUEST['srh-btn']))
                     {
                       ...
                       $search_query = mysqli_query($connection, "select tbl_employees.first_name, tbl_employees.last_name, tbl_employees.department, tbl_attendance.date, tbl_attendance.shift from tbl_employees inner join tbl_attendance on tbl_attendance.employee_id=tbl_employees.employee_id where tbl_attendance.department='$dept' and DATE(tbl_attendance.date) BETWEEN '$from_date' and '$to_date'");
                    ...
                    { ?>
                                    ...
                                    <?php } } else { 
                                    $fetch_query = mysqli_query($connection, "select tbl_employees.first_name, tbl_employees.last_name, tbl_employees.department, tbl_attendance.date, tbl_attendance.shift from tbl_employees inner join tbl_attendance on tbl_attendance.employee_id=tbl_employees.employee_id");
