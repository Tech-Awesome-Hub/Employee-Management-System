...
function getnot($connection){
    ...
    $user_id = getUId($connection) ?? 0;
    $sql = "SELECT id, title, message, created_at FROM tbl_notifications WHERE user_id = ? AND is_read = 0 ORDER BY created_at DESC LIMIT 10";
    $notifications = [];
