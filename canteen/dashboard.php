                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                        <div class="dash-widget">
							...
							<?php
							$fetch_query = mysqli_query($connection, "select count(*) as total from tbl_employees where role=4 and department='$department' and status=1"); 
							...
							<div class="card-block">
								<div class="table-responsive">
									<table class="table mb-0 new-patient-table">
										<tbody>
										<?php 
											$fetch_query = mysqli_query($connection, "select * from tbl_employees where role=4 and department='$department' and status=1 limit 3");
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-8 col-xl-8">
					  ...
					  <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                        <div class="card member-panel">
							<div class="card-header bg-white">
								<h4 class="card-title mb-0">Acitve Leaves</h4>
							</div>
                            <div class="card-body">
                                <!-- <ul class="contact-list">
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                           <span>No active leave available</span>
                                        </div>
                                    </li>
