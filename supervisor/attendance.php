                    ...
                    <div class="card shadow-sm">
                        <div class="card-header ">
                            <div class="dropdown has-arrow text-dark d-flex justify-content-end align-items-center">
                                ...
                                <div class="w-50">
                                    <!-- <button class="btn btn-primary btn-sm float-right mr-2" onclick="exportTableToExcel()"><i class="fa fa-file-excel-o"></i></button>
                                    <button class="btn btn-primary btn-sm float-right mr-2" onclick="exportToPDF()"><i class="fa fa-file-pdf-o"></i></button> -->
                                </div>
